...
RbacRole->name has a length limitation set within the rules variable of the [RbacRole class](https://github.com/Joseph/rbac/blob/master/src/Joseph/Rbac/RbacRole.php#L21).
...
Any issues, please [report here](https://github.com/Joseph/rbac/issues)
